...
export default function Education({ data }) {
  ...
  return (
    <div>
      <Collapse accordion>
        <Panel header="المراحل التعليمية" key="1">
          <Grid
          ...
          >
            ...
            <Grid item xs={10}>
              <Typography variant="subtitle2" gutterBottom>
                {educational_qualification["Educational Institute"]}
              </Typography>
            </Grid>
            <Grid item xs={2}>
              <Typography variant="subtitle1" gutterBottom>
            ...
            <Grid item xs={10}>
              <Typography variant="subtitle2" gutterBottom>
                {educational_qualification["Major"]}
              </Typography>
            </Grid>
            <Grid item xs={2}>
              <Typography variant="subtitle1" gutterBottom>
            ...
            <Grid item xs={10}>
              <Typography variant="subtitle2" gutterBottom>
                {educational_qualification["From"]}
              </Typography>
            </Grid>
            <Grid item xs={2}>
              <Typography variant="subtitle1" gutterBottom>
            ...
            <Grid item xs={10}>
              <Typography variant="subtitle2" gutterBottom>
                {educational_qualification["To"]}
              </Typography>
            </Grid>
          </Grid>
        </Panel>

        {/* <Panel header="الدورات التدريبية" key="2">
          <Grid
            className={classes.gridData}
            container
            direction="row"
